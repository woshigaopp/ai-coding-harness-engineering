...
- AIP Narrative Materialization Gate exists and proves every AIP-owned locked ADEC/DEC plus AIP-time design-affecting MECH/FACT/CONSTRAINT/current architecture/interface/state/runtime/compatibility/verification object is materialized in a standard AIP section, locked N/A, or blocked. Decisions first created by downstream owner stages do not retroactively invalidate AIP unless they expose a missing or wrong AIP-owned decision.
